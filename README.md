...
### Spack and Guix instructions

You can either use spack with ```spack install mojitos``` or guix (using [guix-science](https://codeberg.org/guix-science/guix-science) channel) with ```guix install mojitos```
...
<img src="https://www.irit.fr/energumen/images/energumen.png" height="100">
<img src="doc/numpex.png" height="100">
<img src="doc/e2cc.png" height="100">
...
```
Georges da Costa. MojitO/S. 2026, ⟨swh:1:rev:134db5b460b3d17f6f30983e8a0e2817efecc765⟩. ⟨hal-03453537v2⟩ 
```

Or directly use the following bibtex entry:

```
@softwareversion{dacosta:hal-03453537v2,
  TITLE = {{MojitO/S}},
  ...
  YEAR = {2026},
  MONTH = Feb,
  SWHID = {swh:1:rev:134db5b460b3d17f6f30983e8a0e2817efecc765},
  VERSION = {2.0.2},
